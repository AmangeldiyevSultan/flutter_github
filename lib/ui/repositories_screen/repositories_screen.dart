...
import 'package:flutter_github/data/repositories/repositories_services.dart';
import 'package:flutter_github/ui/repository_page/repository_screen.dart';
import 'package:flutter_github/domains/models/repositories_model.dart';
...
import '../../data/common/utils/git_language_color.dart';
import '../../data/common/widgets/error_state.dart';
import '../../data/common/widgets/loader.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          localization(context).repositories,
