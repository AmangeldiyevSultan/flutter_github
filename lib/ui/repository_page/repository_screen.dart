...
import 'package:flutter_github/ui/repository_page/widgets/span_icon_text.dart';
            ...
            SingleChildScrollView(
              child: Column(children: [
                ...
                Row(
                  ...
                  children: [
                    SpanIconText(
                      text: localization(context).issues,
                    ...
                    GestureDetector(
                      ...
                      child: Text(
                        localization(context).view_issues,
                        style: const TextStyle(
                          color: Colors.grey,
                          fontSize: 15,
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.data!.statusCode != 200) {
                        return Align(
                            ...
                            child: Text(
                              localization(context).no_readme,
                              style: const TextStyle(
